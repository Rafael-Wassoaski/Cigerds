...
public class CheckBoxAdapter extends ArrayAdapter<SpinnerCheckBox> {
    ...
    public List<SpinnerCheckBox> getList(){
        return  listState;
    }

    public CheckBoxAdapter(Context context, int resource, List<SpinnerCheckBox> objects) {
